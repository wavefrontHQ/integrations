...
import com.wavefront.rest.models.Message;
...
public class PagedMessage {
  ...
  public PagedMessage items(List<Message> items) {
    this.items = items;
    return this;
  }

  public PagedMessage addItemsItem(Message itemsItem) {
    if (this.items == null) {
  ...
  public PagedMessage limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PagedMessage cursor(String cursor) {
    this.cursor = cursor;
    return this;
  }
  ...
  public PagedMessage totalItems(Integer totalItems) {
  ...
  public PagedMessage moreItems(Boolean moreItems) {
  ...
  public PagedMessage sort(Sorting sort) {
    this.sort = sort;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedMessage pagedMessage = (PagedMessage) o;
    return Objects.equals(this.items, pagedMessage.items) &&
        Objects.equals(this.offset, pagedMessage.offset) &&
        Objects.equals(this.limit, pagedMessage.limit) &&
        Objects.equals(this.cursor, pagedMessage.cursor) &&
        Objects.equals(this.totalItems, pagedMessage.totalItems) &&
        Objects.equals(this.moreItems, pagedMessage.moreItems) &&
        Objects.equals(this.sort, pagedMessage.sort);
  }
