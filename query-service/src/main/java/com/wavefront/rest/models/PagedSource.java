...
public class PagedSource {
  ...
  public PagedSource items(List<Source> items) {
    this.items = items;
    return this;
  }

  public PagedSource addItemsItem(Source itemsItem) {
    if (this.items == null) {
  ...
  public PagedSource limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PagedSource cursor(String cursor) {
    this.cursor = cursor;
    return this;
  }
  ...
  public PagedSource totalItems(Integer totalItems) {
  ...
  public PagedSource moreItems(Boolean moreItems) {
  ...
  public PagedSource sort(Sorting sort) {
    this.sort = sort;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedSource pagedSource = (PagedSource) o;
    return Objects.equals(this.items, pagedSource.items) &&
        Objects.equals(this.offset, pagedSource.offset) &&
        Objects.equals(this.limit, pagedSource.limit) &&
        Objects.equals(this.cursor, pagedSource.cursor) &&
        Objects.equals(this.totalItems, pagedSource.totalItems) &&
        Objects.equals(this.moreItems, pagedSource.moreItems) &&
        Objects.equals(this.sort, pagedSource.sort);
  }
