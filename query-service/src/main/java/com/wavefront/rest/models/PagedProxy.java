...
public class PagedProxy {
  ...
  public PagedProxy items(List<Proxy> items) {
    this.items = items;
    return this;
  }

  public PagedProxy addItemsItem(Proxy itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Proxy>();
    }
  ...
  public List<Proxy> getItems() {
    return items;
  }

  public void setItems(List<Proxy> items) {
    this.items = items;
  }
  ...
  public PagedProxy limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PagedProxy cursor(String cursor) {
    this.cursor = cursor;
    return this;
  }
  ...
  public PagedProxy totalItems(Integer totalItems) {
  ...
  public PagedProxy moreItems(Boolean moreItems) {
  ...
  public PagedProxy sort(Sorting sort) {
    this.sort = sort;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedProxy pagedProxy = (PagedProxy) o;
    return Objects.equals(this.items, pagedProxy.items) &&
        Objects.equals(this.offset, pagedProxy.offset) &&
        Objects.equals(this.limit, pagedProxy.limit) &&
        Objects.equals(this.cursor, pagedProxy.cursor) &&
        Objects.equals(this.totalItems, pagedProxy.totalItems) &&
        Objects.equals(this.moreItems, pagedProxy.moreItems) &&
        Objects.equals(this.sort, pagedProxy.sort);
  }
