...
public class PagedMaintenanceWindow {
  @SerializedName("items")
  private List<MaintenanceWindow> items = null;
  ...
  public PagedMaintenanceWindow items(List<MaintenanceWindow> items) {
    this.items = items;
    return this;
  }

  public PagedMaintenanceWindow addItemsItem(MaintenanceWindow itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<MaintenanceWindow>();
    }
  ...
  public List<MaintenanceWindow> getItems() {
    return items;
  }

  public void setItems(List<MaintenanceWindow> items) {
    this.items = items;
  }
  ...
  public PagedMaintenanceWindow limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PagedMaintenanceWindow cursor(String cursor) {
    this.cursor = cursor;
    return this;
  }
  ...
  public PagedMaintenanceWindow totalItems(Integer totalItems) {
  ...
  public PagedMaintenanceWindow moreItems(Boolean moreItems) {
  ...
  public PagedMaintenanceWindow sort(Sorting sort) {
    this.sort = sort;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedMaintenanceWindow pagedMaintenanceWindow = (PagedMaintenanceWindow) o;
    return Objects.equals(this.items, pagedMaintenanceWindow.items) &&
        Objects.equals(this.offset, pagedMaintenanceWindow.offset) &&
        Objects.equals(this.limit, pagedMaintenanceWindow.limit) &&
        Objects.equals(this.cursor, pagedMaintenanceWindow.cursor) &&
        Objects.equals(this.totalItems, pagedMaintenanceWindow.totalItems) &&
        Objects.equals(this.moreItems, pagedMaintenanceWindow.moreItems) &&
        Objects.equals(this.sort, pagedMaintenanceWindow.sort);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedMaintenanceWindow {\n");
