...
public class PagedNotificant {
  @SerializedName("items")
  private List<Notificant> items = null;
  ...
  public PagedNotificant items(List<Notificant> items) {
    this.items = items;
    return this;
  }

  public PagedNotificant addItemsItem(Notificant itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Notificant>();
    }
  ...
  public List<Notificant> getItems() {
    return items;
  }

  public void setItems(List<Notificant> items) {
    this.items = items;
  }
  ...
  public PagedNotificant limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PagedNotificant cursor(String cursor) {
    this.cursor = cursor;
    return this;
  }
  ...
  public PagedNotificant totalItems(Integer totalItems) {
  ...
  public PagedNotificant moreItems(Boolean moreItems) {
  ...
  public PagedNotificant sort(Sorting sort) {
    this.sort = sort;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedNotificant pagedNotificant = (PagedNotificant) o;
    return Objects.equals(this.items, pagedNotificant.items) &&
        Objects.equals(this.offset, pagedNotificant.offset) &&
        Objects.equals(this.limit, pagedNotificant.limit) &&
        Objects.equals(this.cursor, pagedNotificant.cursor) &&
        Objects.equals(this.totalItems, pagedNotificant.totalItems) &&
        Objects.equals(this.moreItems, pagedNotificant.moreItems) &&
        Objects.equals(this.sort, pagedNotificant.sort);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedNotificant {\n");
