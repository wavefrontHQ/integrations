...
public class PagedUserGroup {
  ...
  public PagedUserGroup items(List<UserGroup> items) {
    this.items = items;
    return this;
  }

  public PagedUserGroup addItemsItem(UserGroup itemsItem) {
    if (this.items == null) {
  ...
  public PagedUserGroup limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PagedUserGroup cursor(String cursor) {
    this.cursor = cursor;
    return this;
  }
  ...
  public PagedUserGroup totalItems(Integer totalItems) {
  ...
  public PagedUserGroup moreItems(Boolean moreItems) {
  ...
  public PagedUserGroup sort(Sorting sort) {
    this.sort = sort;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedUserGroup pagedUserGroup = (PagedUserGroup) o;
    return Objects.equals(this.items, pagedUserGroup.items) &&
        Objects.equals(this.offset, pagedUserGroup.offset) &&
        Objects.equals(this.limit, pagedUserGroup.limit) &&
        Objects.equals(this.cursor, pagedUserGroup.cursor) &&
        Objects.equals(this.totalItems, pagedUserGroup.totalItems) &&
        Objects.equals(this.moreItems, pagedUserGroup.moreItems) &&
        Objects.equals(this.sort, pagedUserGroup.sort);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedUserGroup {\n");
