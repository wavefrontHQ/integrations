...
public class PagedIntegration {
  @SerializedName("items")
  private List<Integration> items = null;
  ...
  public PagedIntegration items(List<Integration> items) {
    this.items = items;
    return this;
  }

  public PagedIntegration addItemsItem(Integration itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Integration>();
    }
  ...
  public List<Integration> getItems() {
    return items;
  }

  public void setItems(List<Integration> items) {
    this.items = items;
  }
  ...
  public PagedIntegration limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PagedIntegration cursor(String cursor) {
    this.cursor = cursor;
    return this;
  }
  ...
  public PagedIntegration totalItems(Integer totalItems) {
  ...
  public PagedIntegration moreItems(Boolean moreItems) {
  ...
  public PagedIntegration sort(Sorting sort) {
    this.sort = sort;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedIntegration pagedIntegration = (PagedIntegration) o;
    return Objects.equals(this.items, pagedIntegration.items) &&
        Objects.equals(this.offset, pagedIntegration.offset) &&
        Objects.equals(this.limit, pagedIntegration.limit) &&
        Objects.equals(this.cursor, pagedIntegration.cursor) &&
        Objects.equals(this.totalItems, pagedIntegration.totalItems) &&
        Objects.equals(this.moreItems, pagedIntegration.moreItems) &&
        Objects.equals(this.sort, pagedIntegration.sort);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedIntegration {\n");
